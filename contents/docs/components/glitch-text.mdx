---
title: Glitch Text
description: A customizable, accessible and versatile glitch text component with more than 12 pre-built glitch effects and animations.
---
...
<Tabs defaultValue="preview" className="w-full mb-4">
  ...
  <TabsContent value="preview">
    <ZyfloWindowMockup>
      <ZyfloGlitchText
        variant="aggressive-glitch"
        text="Aggressive Glitch"
        size="lg"
        colors={{
          text: "hsl(var(--foreground))",
          after: "#FF0000",
...
<Tabs defaultValue="preview" className="w-full mb-4">
  ...
  <TabsContent value="preview">
    <ZyfloWindowMockup>
      <ZyfloGlitchText
        variant="disappearing-fragments"
        text="Disappearing Fragments"
        size="lg"
        colors={{
          text: "hsl(var(--foreground))"
        }}
...
<Tabs defaultValue="preview" className="w-full mb-4">
  ...
  <TabsContent value="preview">
    <ZyfloWindowMockup>
      <ZyfloGlitchText
        variant="vertical-glitch"
        text="Vertical Glitch"
        size="lg"
        colors={{
          text: "hsl(var(--foreground))",
          after: "#FF0000",
...
<Tabs defaultValue="preview" className="w-full mb-4">
  ...
  <TabsContent value="preview">
    <ZyfloWindowMockup>
      <ZyfloGlitchText
        variant="vhs-retro-glitch"
        text="VHS Retro Glitch"
        size="lg"
        colors={{
          text: "hsl(var(--foreground))",
          after: "#FF0000",
...
<Tabs defaultValue="preview" className="w-full mb-4">
  ...
  <TabsContent value="preview">
    <ZyfloWindowMockup>
      <ZyfloGlitchText
        variant="color-box-glitch"
        text="Color Box Glitch"
        size="lg"
        colors={{
          text: "hsl(var(--foreground))",
          after: "#FF0000",
...
<Table>
  <TableCaption>ZyfloGlitchText Component Props</TableCaption>
  <TableHeader>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell className="w-[25%] md:block hidden">ZyfloGlitchTextVariant</TableCell>
      <TableCell className="w-[15%] lg:block hidden">"color"</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">The glitch effect variant to apply</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="md:w-[19%] w-[35%]">text</TableCell>
      <TableCell className="w-[25%] md:block hidden">string</TableCell>
      <TableCell className="w-[15%] lg:block hidden">-</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">The text content to display with the glitch effect</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="md:w-[19%] w-[35%]">size</TableCell>
      <TableCell className="w-[25%] md:block hidden">"sm" | "md" | "lg"</TableCell>
      <TableCell className="w-[15%] lg:block hidden">"md"</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">The size of the glitch text</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="md:w-[19%] w-[35%]">colors</TableCell>
      <TableCell className="w-[25%] md:block hidden">{'{ text?: string; after?: string; before?: string }'}</TableCell>
      <TableCell className="w-[15%] lg:block hidden">-</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">Custom colors for the glitch effect</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="md:w-[19%] w-[35%]">intensity</TableCell>
      <TableCell className="w-[25%] md:block hidden">number</TableCell>
      <TableCell className="w-[15%] lg:block hidden">1</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">The intensity of the glitch effect</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell className="w-[25%] md:block hidden">string</TableCell>
      <TableCell className="w-[15%] lg:block hidden">-</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">Accessible label for the glitch text</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="md:w-[19%] w-[35%]">className</TableCell>
      <TableCell className="w-[25%] md:block hidden">string</TableCell>
      <TableCell className="w-[15%] lg:block hidden">-</TableCell>
      <TableCell className="lg:w-[41%] md:w-[56%] w-[65%]">Additional CSS classes to apply to the component</TableCell>
    </TableRow>
  </TableBody>
</Table>
